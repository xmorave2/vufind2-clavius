 ...
 * @link     http://vufind.org   Main Site
 */
class VuFind_Model_Db_Tags extends Zend_Db_Table_Abstract
{
    // @codingStandardsIgnoreStart
    protected $_name = 'tags';
    protected $_primary = 'id';
    protected $_rowClass = 'VuFind_Model_Db_TagsRow';
    ...
    public function getForResource($id, $source = 'VuFind', $limit = 0,
        ...
        $select->setIntegrityCheck(false)   // allow join
            ...
            ->join(array('rt' => 'resource_tags'), 't.id = rt.tag_id')
            ->join(array('r' => 'resource'), 'rt.resource_id = r.id')
