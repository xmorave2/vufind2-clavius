...
(function($){
  var methods = {
    ...
    setHandlers: function(elem,state) {
      ...
      $('.turn_left',elem).click(function() {           // rotate image counter-clockwise
          state.angle -= 90;
      ...
      $('.turn_right',elem).click(function() {          // rotate image clockwise
          state.angle += 90;
          $(elem).find('.doc,.doc_map img').rotate(state.angle);
          // center
          methods.resize($('.doc',elem),elem,state);
    ...
    load: function(elem,src) {
      ...
      $('.doc',elem)
        ...
        .load(function() {
          ...
          methods.resize($('.doc',elem),elem,state);
          methods.setDrag($('.doc',elem),elem,state);
          methods.mapDrag({position:{left:$(elem).offset().left-$(this).offset().left,top:$(elem).offset().top-$(this).offset().top}},elem,this,state);
          // show signs of life
