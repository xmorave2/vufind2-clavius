 ...
 * @link     http://vufind.org/wiki/building_a_recommendations_module Wiki
 */
abstract class VF_Recommend_SearchObject implements VF_Recommend_Interface
{
    protected $results;
    protected $limit;
    ...
    public function init($params, $request)
    {
        ...
        $paramsClass = 'VF_Search_' . $id . '_Params';
        $params = new $paramsClass();
        $params->setLimit($this->limit);
        $params->setBasicSearch($request->getParam($this->requestParam));

        // Perform the search:
        $resultsClass = 'VF_Search_' . $id . '_Results';
