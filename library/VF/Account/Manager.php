...
class VF_Account_Manager
{
    ...
    {
        $registry = Zend_Registry::getInstance();
        $registry->set('VF_Account', new VF_Account_Manager());
    }
    ...
    public function logout($url, $destroy = true)
    {
        ...
        if ($destroy) {
            ...
            // There should be a way to do this through Zend_Session, but there
