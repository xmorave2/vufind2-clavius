...
class VF_XSLT_Import
{
    ...
    protected static function generateXML($xmlFile, $properties)
    {
        ...
        $properties = VF_Config_Reader::getConfigPath($properties, 'import');
        ...
        $xslFile = VF_Config_Reader::getConfigPath(
    ...
    protected static function initProcessor($options)
    {
        ...
        if (isset($options['General']['custom_class'])) {
            ...
            foreach ($classes as $class) {
                ...
                eval("class $class extends VF_XSLT_Import_$class { }");
