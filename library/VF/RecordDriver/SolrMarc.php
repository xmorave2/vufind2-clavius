 ...
 * @link     http://vufind.org/wiki/other_than_marc Wiki
 */
class VF_RecordDriver_SolrMarc extends VF_RecordDriver_SolrDefault
{
    ...
    public function getRealTimeHistory()
    {
        ...
        try {
            return VF_Connection_Manager::connectToCatalog()->getPurchaseHistory(
                $this->getUniqueID()
            );
    ...
    protected function getRealTimeTitleHold()
    {
        ...
        if ("monograph" == strtolower($biblioLevel)
            ...
            if (VF_ILS_Connection::getTitleHoldsMode() != "disabled") {
                $holdLogic = new VF_Logic_TitleHolds();
