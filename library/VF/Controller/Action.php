 ...
 * @link     http://vufind.org/wiki/building_a_recommendations_module Wiki
 */
class VF_Controller_Action extends Zend_Controller_Action
{
    /**
    ...
    protected function catalogLogin()
    {
        ...
        if (($username = $this->_request->getParam('cat_username', false))
            && ($password = $this->_request->getParam('cat_password', false))
        ) {
