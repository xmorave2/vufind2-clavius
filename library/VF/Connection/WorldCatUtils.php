 ...
 * @link     http://vufind.org/wiki/system_classes Wiki
 */
class VF_Connection_WorldCatUtils
{
    /**
    ...
    public function getRelatedTerms($term, $vocabulary = 'lcsh', $maxRecords = 10)
    {
        ...
        $marcxml = VF_XSLT::process('wcterms-marcxml.xsl', $data);
