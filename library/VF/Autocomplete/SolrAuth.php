 ...
 * @link     http://vufind.org/wiki/autocomplete Wiki
 */
class VF_Autocomplete_SolrAuth extends VF_Autocomplete_Solr
{
    /**
     * Constructor
     *
    ...
    protected function initSearchObject()
    {
        ...
        $params = new VF_Search_SolrAuth_Params();
        $this->searchObject = new VF_Search_SolrAuth_Results($params);
    }
}
