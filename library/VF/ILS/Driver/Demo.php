 ...
 * @link     http://vufind.org/wiki/building_an_ils_driver Wiki
 */
class VF_ILS_Driver_Demo implements VF_ILS_Driver_Interface
{
    ...
    public function __construct()
    {
        ...
        // on Solr hits):
        $this->session = new Zend_Session_Namespace('DemoDriver');
    }
    ...
    protected function prepSolr()
    {
        ...
        $this->db = VF_Connection_Manager::connectToIndex();
     ...
     * @param boolean $append  - add another record or replace current record
     *
