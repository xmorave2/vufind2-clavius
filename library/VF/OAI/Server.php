...
class VF_OAI_Server
{
    ...
    protected function attachNonDeleted($container, $record, $format,
        ...
        if (!$headerOnly) {
            ...
            VF_SimpleXML::appendElement($metadata, simplexml_load_string($xml));
        }
    ...
    protected function listSets()
    {
        ...
        $paramsClass = 'VF_Search_' . $this->searchClassId . '_Params';
        $params = new $paramsClass();
        $resultsClass = 'VF_Search_' . $this->searchClassId . '_Results';
     ...
     *
     * @return VF_Search_Base_Results Search result object.
     */
    ...
    protected function showResponse($body, $echoParams = true)
    {
        ...
        // Attach main body:
        VF_SimpleXML::appendElement($xml, $body);
